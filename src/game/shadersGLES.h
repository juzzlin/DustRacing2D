...
#ifndef SHADERSGLES_H
#define SHADERSGLES_H
...
""
"    float diffuseLightIntensity = dot(diffuseLightDir, vec4(-inNormal, 1)) * diffuseLightColor.a * 0.5;\n"
...
"         else\n"
"         {\n"
"             gl_FragColor = (texColor * vColor).rgba * dot(diffuseLightDirRotated, ((map - vec4(0.5, 0.5, 0.5, 0.0)) * 2.0));\n"
"         }\n"
"    }\n"
"}\n";
...
"    float diffuseLightIntensity = dot(diffuseLightDir, vec4(-inNormal, 1)) * diffuseLightColor.a;\n"
"    vColor = inColor * (\n"
"        vec4(ambientLightColor.rgb, 1.0) * ambientLightColor.a +\n"
"        vec4(diffuseLightColor.rgb, 1.0) * diffuseLightIntensity) * fade;\n"
""
