...
MCSpringForceGenerator2dFastImpl::MCSpringForceGenerator2dFastImpl(MCObject * p2,
                                                                   MCFloat coeff,
                                                                   MCFloat length,
                                                                   MCFloat min,
                                                                   MCFloat max) :
...
MCSpringForceGenerator2dFast::MCSpringForceGenerator2dFast(MCObject * p2,
                                                           MCFloat coeff,
                                                           MCFloat length,
                                                           MCFloat min,
                                                           MCFloat max) :

    m_pImpl(new MCSpringForceGenerator2dFastImpl(p2, coeff, length, min, max))
{}
