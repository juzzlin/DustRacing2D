...
{
    return MCSeparationEvent::m_typeId;
}

unsigned int MCSeparationEvent::instanceTypeId() const
{
    return MCSeparationEvent::m_typeId;
}

MCObject & MCSeparationEvent::separatedObject() const
{
    return m_separatedObject;
}

MCSeparationEvent::~MCSeparationEvent() = default;
